...
class Poem(db.Model):
    ...
    comments = db.relationship('Comment', back_populates='poem', cascade='all, delete-orphan')
    liked_by = db.relationship('User', secondary=likes, back_populates='liked_poems', lazy='dynamic')
